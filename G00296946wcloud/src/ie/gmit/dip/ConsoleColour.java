 ...
 * @enum ConsoleColour stores colours for command line terminal
 */
//enum of ConsoleColour
public enum ConsoleColour { // ANSI escape codes. These make the UI look a little more presentable.
	...
	private final String colour; // object

	ConsoleColour(String colour) { // constructor
		this.colour = colour;
	}
